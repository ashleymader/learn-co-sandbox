...
site = "https://www.amazon.com/charts?ref=chrt_bk_nav_logo"
...
things = doc.css("#a-page .kc-body .kc-rank-card-metadata")
# ("parent#some-id children.some-class")
...
# # # # See if you can find the data you will want to show your user
 things.each do |thing|
   detail_one = thing.css(".kc-rank-card-title").text
  detail_two = thing.css("kc-rank-card-author").text
  detail_three = thing.css(".kc-wol").text
